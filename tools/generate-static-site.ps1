...
function HeaderHtml($path, $title, $description, $h1, $body, $schema = "") {
  ...
  $active = if($path -match "/products/"){"Products"}elseif($path -match "/industries/"){"Industries"}elseif($path -match "/solutions/"){"Solutions"}elseif($path -match "/markets/"){"Markets"}elseif($path -match "/technical-support|/downloads"){"Support"}elseif($path -match "/about/"){"Company"}elseif($path -match "/news/|/blog/"){"News"}elseif($path -match "/contact/"){"Contact"}else{"Home"}
  $nav = @(
    @("Home","$base/"),@("Solutions","$base/solutions/"),@("Markets","$base/markets/"),@("News","$base/news/"),@("Support","$base/technical-support/"),@("Company","$base/about/"),@("Contact","$base/contact/")
  )
